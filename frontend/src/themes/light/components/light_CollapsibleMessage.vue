...
/* Ensure high-contrast readability inside light theme chat bubbles */
.message-text.markdown-body,
.message-text.markdown-body :is(
  p, li, ul, ol, blockquote, span, div,
  h1, h2, h3, h4, h5, h6,
  strong, em, b, i
) {
...
/* Chat "copy original content" button */
.copy-btn {
